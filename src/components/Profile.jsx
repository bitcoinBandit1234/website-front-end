      ...
      <div className="maincontainer-profile">
        <div className="sub-contain">
          <div className="profile-leftbar">
            ...
            <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", width: "100%" }} className="spacer-menu">
              <ul style={{ flex: 1 }} className="menu-col">
                <li className={activeTab === "/dash" ? "active" : ""}>
                  <Link to="/dashboard/dash" onClick={() => handleTabClick("/dash")}>
                    Dashboard
                  </Link>
                </li>
