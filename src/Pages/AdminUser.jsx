        ...
        <div style={{ padding: "0 40px" }}>
            <div>
                <h2 style={{
                    ...
                    letterSpacing: '2px',
                    lineHeight: '1.5', fontWeight: "500", marginTop: "50px"
                }}>PROFILE DETAIL</h2>
                <h3 style={{ color: "#606060", marginTop: "30px" }}>PROFILE DETAILS HERE </h3>
            </div>
            <div style={{ marginTop: "30px", display: "flex", flexDirection: "row", flexWrap: "wrap" }}>
                <div style={{ display: "flex", flexDirection: "column", width: "30%", gap: "4px" }}>
                ...
                <div style={{ marginTop: "50px", display: "flex", flexDirection: "column", width: "30%", gap: "4px" }}>
